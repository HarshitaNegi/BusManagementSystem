        ...
        <br><br><br>
         <table class="table">
                ...
                <tbody>
                    ...
                    <td><%=routeno%></td>
                    <td><%=route%></td>
                    <td><a href="Driverupdate.jsp?id=<%=id%>&driverid=<%=driverid%>&drivername=<%=drivername%>&busno=<%=busno%>&routeno=<%=routeno%>&route=<%=route%>"  class="table"></a> 
                ...
                <tbody>
                <td colspan="10" align="center"><br><br> <input type="submit" class="btnn btnn-hover" value="Delete Selected Driver"> </td>
                </tbody>
<!--                <tbody>
